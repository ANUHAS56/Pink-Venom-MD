...
module.exports = {
    ...
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'ANUHAS56' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    ...
    OWNER: process.env.OWNER === undefined ? `94704982537` : process.env.OWNER, //BOTS OWNER NUMBER
